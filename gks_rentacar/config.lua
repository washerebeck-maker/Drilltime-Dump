Config = Config or {}
Config.ESXLogout = "esx:onPlayerLogout"
...
Config.NotMoney = "You don't have enough money!"
Config.ReturnCars = "The rental was canceled because you did not have enough money."
