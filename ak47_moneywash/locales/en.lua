Locales["en"] = {
    ...
    minimum = "~y~Minimum amount $%s",
    maximum = "~y~Maximum amount $%s",
    ...
    notenough = "~y~You don\"t have that much money!",
    received = "~g~You recieved $%s",
    nocard = "~r~You don\'t have Laundry Card!",
