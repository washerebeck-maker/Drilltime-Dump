...
function ReloadChar()
    if exports.JD_CommunityService:InCommunityService() then
        ESX.ShowNotification('You cannot use this in community service.')
        return
    end
...
AddEventHandler('esx_skin:openSaveableMenu', function(submitCb, cancelCb)
	...
	TriggerServerEvent('fivem-appearance:enterCustomizationBucket')
	exports['fivem-appearance']:startPlayerCustomization(function (appearance)
		if (appearance) then
			TriggerServerEvent('fivem-appearance:save', appearance)
			ESX.SetPlayerData('ped', PlayerPedId())
		...
		TriggerServerEvent('fivem-appearance:exitCustomizationBucket')
	end, config)
end)
