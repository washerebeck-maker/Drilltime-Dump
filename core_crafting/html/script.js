  ...
  for (const [key1, value1] of Object.entries(categories)) 
  {
    ...
    if (add) 
    {
      first = first + '    <div class="clearfix colelem recipe" data-category="' + key1 + '" onclick="openCrafting(this)" id="pu212"><!-- group -->' +
        ...
        '      <p>' + value1.Label + '</p>' +
        '     </div>' +
        '     <div class="museBGSize grpelem" id="u264" style="background: url('+images + value1.Image + '.png) no-repeat center; background-size: 120%; " data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- simple frame --></div>' +
        '    </div>';
    }
...
function openCrafting(t) {
  ...
  for (const [key, value] of Object.entries(recipes)) {
    ...
    if (value.Category == category) {
      ...
      if ((value.item != undefined && skills[value.item] == undefined) || value.Level > level) {
        ...
        if (!hidecraft) {
          ...
          second = second + '    <div class="clearfix colelem recipe" onclick="inspect(this)" data-item="' + key + '" style="opacity: 0.5;" id="pu212"><!-- group -->' +
            ...
            '     </div>' +
            '     <div class="museBGSize grpelem" id="u264" style="background: url('+images + key + '.png) no-repeat center; background-size: 120%; " data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- simple frame --></div>' +
        ...
        if (value.requireBlueprint && (inventory[key + '_blueprint'] == 0 || inventory[key + '_blueprint'] == null)) {
          if (!hidecraft) {
            ...
            second = second + '    <div class="clearfix colelem recipe" data-item="' + key + '" onclick="inspect(this)" style="opacity: 0.5;" id="pu212"><!-- group -->' +
              '     <div class="gradient grpelem" id="u212" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- simple frame --></div>' +
              '     <div class="clearfix grpelem" id="u225-4" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- content -->' +
              '      <p>' + String(names[key]).toUpperCase() + 'jj</p>' +
              '     </div>' +
              '     <div class="museBGSize grpelem" id="u264" style="background: url('+images + key + '.png) no-repeat center; background-size: 120%; " data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- simple frame --></div>' +
              '     <div class="rounded-corners clearfix grpelem" id="u270-4" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- content -->' +
              '      <p>' + timeString + '</p>' +
          ...
          if (value.Jobs.includes(job) || Object.keys(value.Jobs).length == 0) {
            ...
            if (value.JobGrades.includes(grade) || Object.keys(value.JobGrades).length == 0) {
              first = first + '    <div class="clearfix colelem recipe" data-item="' + key + '" onclick="inspect(this)" id="pu212"><!-- group -->' +
                '     <div class="gradient grpelem" id="u212" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- simple frame --></div>' +
                '     <div class="clearfix grpelem" id="u225-4" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- content -->' +
                '      <p>' + String(names[key]).toUpperCase() + (value.item != undefined ? '&nbsp;<i class="fa-solid fa-star" style="color:gold"></i>' : '')+'</p>' +
                '     </div>' +
                '     <div class="museBGSize grpelem" id="u264" style="background: url('+images + key + '.png) no-repeat center; background-size: 120%; " data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- simple frame --></div>' +
                '     <div class="rounded-corners clearfix grpelem" id="u270-4" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu212"><!-- content -->' +
                '      <p>' + timeString + '</p>' +
...
function addToQueue(item, time, id) {
  ...
  if ($("#" + id).length) {
    ...
    var base = '    <div class="slide-left queue" id="' + id + '"><!-- group -->' +
      ...
      '     </div>' +
      '     <div class="museBGSize grpelem" style="background: url('+images + item + '.png) no-repeat center; background-size: 120%; " id="u546" data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu544"><!-- simple frame --></div>' +
...
function craft(t) {
  ...
  $.post('https://core_crafting/craft', JSON.stringify({
    item: item
  }));
...
function inspect(t) 
{
  if (opened != t) 
  {
      ...
      var base = '   <div class="slide-bottom " id="pu386"><!-- group -->' +
        ...
        '    <div class="museBGSize grpelem" id="u389" style="background: url('+images + t.dataset.item + '.png) no-repeat center; background-size: 120%; " data-sizePolicy="fixed" data-pintopage="page_fixedCenter" data-leftAdjustmentDoneBy="pu386"><!-- simple frame --></div>' +
      ...
      for (const [key, value] of Object.entries(ingredients)) 
      {
          if (inventory[key] >= value) 
          {
              first = first + '<div class="ingredient" id="' + key + '">' +
                  ...
                  '<div id="ingredient-logo" style="background: url('+images + key + '.png) no-repeat center; background-size: 120%; "></div>' +
                  '</div>';
          } 
          else 
          {
