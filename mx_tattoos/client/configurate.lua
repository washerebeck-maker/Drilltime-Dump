...
-- Notify lua
Texts = {
    Open_Store = "Welcome to our store !!!",                                  
    Close_Store = "Check back often !!!",                                                  
