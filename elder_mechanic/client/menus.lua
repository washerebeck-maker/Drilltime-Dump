    ...
    ['main'] = {
        ...
        options = {
            {label = 'Repair', img = 'img/icons/repair.png', price = Config.VehicleRepairPrice, onSelect = function() repairtVehicle(customVehicle) end},
            {
                ...
                price = Config.EngineSetupPrice, 
                onSelect = function()
                    local plate =  MathTrim(GetVehicleNumberPlateText(customVehicle))
                    closeUI(1,1)
                    lib.progressBar({
                        duration = 60 * 1000,
                    ...
                    TriggerServerEvent('elder_cartheft:server:addEngine', plate)
                end
            },
            {
                label = 'Alarm', 
                img = 'img/icons/horn.png', 
                price = Config.AlarmPrice, 
                onSelect = function() 
                    ESX.TriggerServerCallback('lls-mechanic:server:checkVehicle', function(result)

                        if result then
                            alarmVehicle(customVehicle) 
                        else
                            ESX.ShowNotification('The vehicle is not owned')
                        end
                    end, MathTrim(GetVehicleNumberPlateText(customVehicle)))
        ...
        ['visual'] = {
            ...
            ['inside_parts'] = {
                title = 'INSIDE PARTS',
                options = {
                    {label = 'Dashboard', img = 'img/icons/dashboard.png', modType = 29, priceMult = Config.VehicleCustomisePriceMultiplier['dashboard'], onSelect = function()
                        moveToCameraToBoneSmoth(customCamMain, customCamSec, customVehicle, 'interiorlight', {x = 0.0, y = -1.0, z = -0.1}, {x = 0.0, y = 0.0, z = 0.0})
                    end, onSubBack = function()
                        SetCamActiveWithInterp(customCamMain, customCamSec, 500, true, true)
                    end},
                    {label = 'Dashboard Color', img = 'img/icons/dashboardColor.png', modType = 'dashboardColor', customType = 'color', priceMult = Config.VehicleCustomisePriceMultiplier['dashboard_color'], onSelect = function()
                    ...
                    {label = 'Plaques', img = 'img/icons/plaques.png', modType = 35, priceMult = Config.VehicleCustomisePriceMultiplier['plaques']},
                    ...
                    {label = 'Interior Color', img = 'img/icons/interiorColor.png', modType = 'interiorColor', customType = 'color', priceMult = Config.VehicleCustomisePriceMultiplier['interior_color'], onSelect = function()
            ...
            ['wheels'] = {
                ...
                ['wheels_type'] = {
                    ...
                    options = {
                        ...
                        {label = 'Open Wheel', img = 'img/icons/wheel.png', modType = 23, priceMult = Config.VehicleCustomisePriceMultiplier['open_wheel'], onSelect = function() SetVehicleModData(customVehicle, 'wheels', 10) end},
                        {label = 'Street', img = 'img/icons/wheel.png', modType = 23, priceMult = Config.VehicleCustomisePriceMultiplier['street'], onSelect = function() SetVehicleModData(customVehicle, 'wheels', 11) end}
                    },
